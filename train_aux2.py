...
parser.add_argument('--random_method', type=str, default=None, help="ratio or prob")
...
if __name__ == '__main__':
	...
	log_path = "aux_logs/" + file_name + "_" + str(experimentID) + "_" + "random" + str(AUXexperimentID) + ".log"
